...
const staticServiceImageMap: Record<string, string> = {
  ...
  "small-lean-to-canopies": "/brand/services/small-lean-to-canopies.png",
  "large-lean-to-canopies": "/brand/services/large-lean-to-canopies.jpg",
  "flat-top-canopies": "/brand/services/flat-top-canopies.png",
  ...
  chimneys: "/brand/services/chimneys.png",
};
